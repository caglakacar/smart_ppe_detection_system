...
<p align="center">
 A deep learning-based web application for detecting Personal Protective Equipment (PPE) using the YOLOv8 object detection model. The system supports detection via image upload, video file processing, and real-time webcam analysis. It provides a visual interface to monitor compliance, calculate a safety score, and store detection logs and results for later review.
</p>
</br>
...
This project relies on the following third-party Python libraries:
...
- **Model:** YOLOv8n (Nano) - provided by [Ultralytics](https://github.com/ultralytics/ultralytics). The best model (`best.pt`) was exported and integrated into the Flask web app.
